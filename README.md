...
<head>
  ...
  <meta name="description" content="Limpiezas a fondo profesionales en toda la provincia de Barcelona. Servicios desde 20 € la hora. Pide tu presupuesto sin compromiso." />
...
<body>
    ...
    <section class="hero">
      <div class="container hero-grid">
        <div>
          ...
          <div class="hero-meta">
            <span>Precio orientativo desde: <strong>20 € / hora</strong></span>
        ...
        <aside class="hero-card">
          ...
          <div class="hero-price">
            <span class="hero-price-main">Desde 20 € / hora</span>
            <span class="hero-price-note">Según estado, metros y servicios extra.</span>
          </div>
        </aside>
      </div>
    </section>
      ...
      <div class="container pricing">
        ...
        <div class="pricing-grid">
          ...
          <aside class="pricing-card">
            ...
            <div class="pricing-main">Desde 20 € / hora</div>
  ...
  <script>
    ...
    // Formulario "funcional" con mailto (GitHub Pages no tiene backend)
